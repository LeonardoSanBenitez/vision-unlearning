...
all_ideas = class_available + theme_available
for idea in all_ideas:
    print(idea)
    input_file = f"assets/data/metadata/metadata-{idea}-retain.json"
    output_file = f"assets/data/metadata/cleaned/metadata-{idea}-retain.json"
    ...
    for split in data:
        for item in data[split]:
            if "file_name" in item:
                item["file_name"] = item["file_name"].replace("assets/data/", "")
